...
const fetchDeveloperNotification = async(req,res,next)=>
{
    await client.connect()
    const db = client.db('fetchAPIS')
    const collection = db.collection('fetchDeveloperNotificationCollection')
...
module.exports = fetchDeveloperNotification